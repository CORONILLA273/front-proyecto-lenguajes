<template>
  <v-col cols="12">
    ...
    <v-row v-if="!showTeacherDetails" class="mt-3">
      <v-data-table
        :headers="headers"
        :items="maestros"
        elevation="0"
    ...
    <v-row v-if="showTeacherDetails" class="mt-3">
      <div>
        ...
        <p><strong>Name:</strong> {{ selectedTeacher.nameTea }}</p>
        <p><strong>Subject:</strong> {{ selectedTeacher.subjectTea }}</p>
        <p><strong>Class:</strong> {{ selectedTeacher.classTea }}</p>
        <p><strong>Email:</strong> {{ selectedTeacher.emailTea }}</p>
        <p><strong>Gender:</strong> {{ selectedTeacher.genderTea }}</p>
